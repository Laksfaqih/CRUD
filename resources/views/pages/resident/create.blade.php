        ...
        <form action="/resident" method="post">
            <div class="card">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" inputmode="numeric" name="nik" id="nik" class="form-control @error('nik') is-invalid @enderror" value="{{ old('nik') }}">
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea name="address" id="address" cols="30" rows="3" class="form-control @error('address') is-invalid @enderror">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="phone" id="phone" inputmode="numeric" class="form-control @error('phone') is-invalid @enderror" value="{{ old('phone') }}">
            ...
            <div class="card-footer">
                <div class="d-flex rounded justify-content-end" style="gap:10px">
                    <a href="/resident" class="btn btn-outline-secondary">Kembali</a>
                    <button type="submit" class="btn btn-primary rounded px-4 py-2 shadow-sm">Simpan</button>
                </div>
            </div>
        </form>
    </div>
