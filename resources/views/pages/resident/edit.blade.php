...
<div class="row">
    <div class="col">
        <form action="/resident/{{ $resident->id }}" method="GET">
            @csrf
             @method('POST')
            <div class="card">
                <div class="card-body">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="phone" id="phone" inputmode="numeric" class="form-control @error('phone') is-invalid @enderror" value="{{ old('phone', $resident->phone) }}">
            ...
            <div class="card-footer">
                <div class="d-flex rounded justify-content-end" style="gap:10px">
                    ...
                    <button type="submit" class="btn btn-warning rounded px-4 py-2 shadow-sm">Simpan perubahan</button>
                </div>
            </div>
        </form>
    </div>
